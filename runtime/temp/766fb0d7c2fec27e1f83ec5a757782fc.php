<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\wamp\www\project\web\public/../application/admin\view\article\index_cate.html";i:1511754335;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\header.html";i:1511257266;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\footer.html";i:1511257266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <tbody>                       
                            <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): if( count($article)==0 ) : echo "" ;else: foreach($article as $key=>$v): ?>
                                <tr class="long-td">
                                    ...
                                    <td>
                                        <?php if($v['status'] == 1): ?>
                                            <a class="red" href="javascript:;" onclick="cate_state(<?php echo $v['id']; ?>);">
                                    ...
                                    <td>                                   
                                        <a href="<?php echo url('edit_cate',['id'=>$v['id']]); ?>" class="btn btn-primary btn-outline btn-xs">
                                            <i class="fa fa-paste"></i> 编辑</a>&nbsp;&nbsp;
                                        <a href="javascript:;" onclick="del_cate(<?php echo $v['id']; ?>)" class="btn btn-danger btn-outline btn-xs">
                ...
                <form class="form-horizontal" name="add_cate" id="add_cate" method="post" action="<?php echo url('add_cate'); ?>">
                    <div class="ibox-content">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">                                                      
                                    <select name="pid" class="form-control">
                                        ...
                                        <?php if(is_array($article) || $article instanceof \think\Collection || $article instanceof \think\Paginator): if( count($article)==0 ) : echo "" ;else: foreach($article as $key=>$v): ?>
                                            <option value="<?php echo $v['id']; ?>" style="margin-left:55px;"><?php echo $v['lefthtml']; ?><?php echo $v['name']; ?></option>    
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>                                    
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="orderby" id="orderby" value="0" placeholder="输入排序" class="form-control"/>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
...
//菜单状态
function cate_state(id){
    lunhui.status(id,'<?php echo url("cate_state"); ?>');
}
