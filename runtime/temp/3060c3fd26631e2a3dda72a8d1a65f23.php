<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"D:\wamp\www\project\web\public/../application/home\view\tomb\index.html";i:1512097642;s:73:"D:\wamp\www\project\web\public/../application/home\view\public\title.html";i:1512460328;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\header.html";i:1512633002;s:78:"D:\wamp\www\project\web\public/../application/home\view\public\contactWay.html";i:1512456346;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\footer.html";i:1512697646;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\linkjs.html";i:1512110520;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	    		...
	    		<div class="contain_com">
			        ...
			        <div class="breadcrumb">
			            <ul>
			                ...
			                <li>></li>
			                <li><a href="javascript:void(0)">墓型展示</a></li>
			                <li >></li>
			                <li class="jt"><a href="javascript:void(0)"><?php echo $defaultCate['name']; ?></a></li>
			            </ul>
			        </div><!-- 面包屑导航 end -->
			        <!--内容左-->
			        		...
			        		<div class="side_navlist" id="cem_detail_title">
			        			<ul>
			        				<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$vo): ?>
			        					<li tab="<?php echo $vo['id']; ?>" data-url="<?php echo url('home/Tomb/getList'); ?>"<?php if($vo['id'] == $defaultCate['id']): ?> class="thistab"<?php endif; ?>><a href="javascript:void(0)" ><?php echo $vo['name']; ?></a></li>
			        				<?php endforeach; endif; else: echo "" ;endif; ?>
			        			</ul>
			        		</div>
			        	</div><!--侧导航  end-->
			        	...
			        	<div class="news_rightlist">
				        	<ul>
			        			...
			        			<li id="tabcem1" class="cem_details_box">
			        				<div class="matter_title"><?php echo $defaultCate['name']; ?><span>景观展示</span></div>
			        				<!--福寿园列表-->
			        				<div class="matter_list">
			        					<ul id='list_box'>
			        						<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$v): ?>
				        						<li>
				        							<div class="matter_img"><a href="<?php echo url('home/Tomb/detail',array('id'=>$v['id'])); ?>#flagD"><img src="<?php echo $v['photo']; ?>" alt="<?php echo $v['tomb_name']; ?>" /></a></div>
				        							<p><?php echo $v['tomb_name']; ?></p>
				        						</li>		        		
			        						<?php endforeach; endif; else: echo "" ;endif; ?>				
			        					</ul>
			        				</div><!--福寿园列表end-->
...
<script src="__JS__/common.js"></script>  
	    ...
	    <script type="text/javascript" src="__JS__/tomb.js"></script>
