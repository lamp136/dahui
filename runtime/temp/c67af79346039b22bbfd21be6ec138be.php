<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\wamp\www\project\web\public/../application/admin\view\article\add_article.html";i:1512617627;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\header.html";i:1511257266;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\footer.html";i:1511257266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control m-b chosen-select" name="cate_id" id="cate_id">
                                    ...
                                    <?php if(!empty($cate)): if(is_array($cate) || $cate instanceof \think\Collection || $cate instanceof \think\Paginator): if( count($cate)==0 ) : echo "" ;else: foreach($cate as $key=>$v): ?>
                                            <option value="<?php echo $v['id']; ?>" <?php if(!(empty($v['father']) || (($v['father'] instanceof \think\Collection || $v['father'] instanceof \think\Paginator ) && $v['father']->isEmpty()))): ?> disabled <?php endif; ?> ><?php echo $v['lefthtml']; ?><?php echo $v['name']; ?></option>    
...
<script type="text/javascript">
    ...
    var uploader = WebUploader.create({
        ...
        server: "<?php echo url('Upload/upload',array('dir'=>'article')); ?>",// 文件接收服务端。
        ...
        'onUploadSuccess': function(file, data, response) {
            ...
            $("#data_photo").val('/uploads/images/article/' + raw);
            $("#img_data").attr('src', '/uploads/images/article/' + raw).show();
        }
    });
