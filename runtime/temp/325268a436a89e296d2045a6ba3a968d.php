	    		...
	    		<div class="contain_com">
			        ...
			        <div class="breadcrumb">
			            <ul>
			                ...
			                <li >></li>
			                <li><a href="<?php echo url('home/Article/aboutCemetery',array('cid'=>$cate['id'])); ?>"><?php echo $cate['name']; ?></a></li>
			                <li >></li>
			        		...
			        		<div class="side_navlist side_navlheig" id="cem_detail_title">
			        			<ul>
			        				<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$vo): ?>
			        					<li tab="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $cate['id']): ?> class="thistab"<?php endif; ?>><a href="<?php echo url('home/Article/aboutCemetery',array('cid'=>$vo['id'])); ?>#flagD" ><?php echo $vo['name']; ?></a></li>
			        				<?php endforeach; endif; else: echo "" ;endif; ?>
			        			</ul>
			        		</div>
			        	</div><!--侧导航  end-->
