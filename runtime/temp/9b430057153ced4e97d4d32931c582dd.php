<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"D:\wamp\www\project\web\public/../application/home\view\article\detail.html";i:1512441068;s:73:"D:\wamp\www\project\web\public/../application/home\view\public\title.html";i:1512460328;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\header.html";i:1512461103;s:78:"D:\wamp\www\project\web\public/../application/home\view\public\contactWay.html";i:1512456346;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\footer.html";i:1512456236;s:74:"D:\wamp\www\project\web\public/../application/home\view\public\linkjs.html";i:1512110520;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<div class="main_visual">
	    		...
	    		<div class="contain_com">
			        ...
			        <div class="breadcrumb">
			            <ul>
			                ...
			                <li >></li>
			                <li><a href="<?php echo url('home/Article/index',array('cid'=>$cate['id'])); ?>"><?php echo $cate['name']; ?></a></li>
			                <li >></li>
			                <li class="jt"><a href="javascript:void(0)">新闻详情</a></li>
			            </ul>
			        </div><!-- 面包屑导航 end -->
			        <!--内容左-->
			        		...
			        		<div class="side_navlist side_navlheig" id="cem_detail_title">
			        			<ul>
			        				<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$vo): ?>
			        					<li tab="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $cate['id']): ?> class="thistab"<?php endif; ?>><a href="<?php echo url('home/Article/index',array('cid'=>$vo['id'])); ?>#flagI" ><?php echo $vo['name']; ?></a></li>
			        				<?php endforeach; endif; else: echo "" ;endif; ?>
			        			</ul>
			        		</div>
			        	</div><!--侧导航  end-->
			         ...
			         <div class="matter_right">
			         	<ul>
			         		...
			         		<li id="tabcem1" class="cem_details_box">
			         			<div class="matter_title"><?php echo $cate['name']; ?></div>
			         			<!--行业详情内容-->
			         			<div class="news_main">
    ...
    <ul>
        <li><a href="<?php echo url('home/Article/index',array('cid'=>config('about_cemetery'))); ?>">关于陵园</a></li>
        ...
        <li><a href="<?php echo url('home/Article/index',array('cid'=>config('call_me'))); ?>">联系我们</a></li>
    </ul>
