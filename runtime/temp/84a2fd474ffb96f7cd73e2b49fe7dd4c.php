<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"D:\wamp\www\project\web\public/../application/admin\view\scenery\add_scenery.html";i:1512630918;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\header.html";i:1511257266;s:75:"D:\wamp\www\project\web\public/../application/admin\view\public\footer.html";i:1511257266;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add_scenery">

                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>
                            <div class="input-group col-sm-4">
                                <input id="sname" type="text" class="form-control" name="sname" placeholder="输入标题">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="price" type="text" class="form-control" name="price" placeholder="输入价格">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="material" type="text" class="form-control" name="material" placeholder="输入材质">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="orientation" type="text" class="form-control" name="orientation" placeholder="输入朝向">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="size" type="text" class="form-control" name="size" placeholder="输入大小">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="acupoint" type="text" class="form-control" name="acupoint" placeholder="输入穴位">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-5">
                                ...
                                <img id="img_data" width="300px" height="100px" style="float:left;margin-left: 50px;margin-top: -10px;" src="/static/admin/images/no_img.jpg"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input type="text" name="views" id="views" value="0" class="form-control">
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>              
                        <div class="form-group">
