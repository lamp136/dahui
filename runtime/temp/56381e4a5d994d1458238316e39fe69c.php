	    		...
	    		<div class="contain_com">
			        ...
			        <div class="breadcrumb">
			            <ul>
			                ...
			                <li>></li>
			                <li><a href="<?php echo url('home/Product/index'); ?>">产品及服务</a></li>
			                <li >></li>
			                <li><a href="<?php echo url('home/Product/index',array('cid'=>$cate['id'])); ?>"><?php echo $cate['name']; ?></a></li>
			                <li >></li>
			                <li class="jt"><a href="javascript:void(0)"><?php echo $data['product_name']; ?></a></li>
			            </ul>
			        </div><!-- 面包屑导航 end -->
			        <!--内容左-->
			        		...
			        		<div class="side_navlist" id="cem_detail_title">
			        			<ul>
			        				<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$vo): ?>
			        					<li <?php if($vo['id'] == $cate['id']): ?> class="thistab"<?php endif; ?>><a href="<?php echo url('home/Product/index',array('cid'=>$vo['id'])); ?>#flagI" ><?php echo $vo['name']; ?></a></li>
			        				<?php endforeach; endif; else: echo "" ;endif; ?>
			        			</ul>
			        		</div>
			        	</div><!--侧导航  end-->
