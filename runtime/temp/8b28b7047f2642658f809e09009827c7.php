	    		...
	    		<div class="contain_com">
			        ...
			        <div class="breadcrumb">
			            <ul>
			                ...
			                <li>></li>
			                <li><a href="javascript:void(0)">产品及服务</a></li>
			                <li >></li>
			        ...
			        <div class="matter_left">
			        	<!--侧导航-->
			        	<div class="side_nav">
			        		<div class="side_navtitle">产品及服务</div>
			        		<div class="side_navlist" id="cem_detail_title">
			        			<ul>
			        				<?php if(is_array($category) || $category instanceof \think\Collection || $category instanceof \think\Paginator): if( count($category)==0 ) : echo "" ;else: foreach($category as $key=>$vo): ?>
			        					<li tab="<?php echo $vo['id']; ?>" data-url="<?php echo url('home/Product/getList'); ?>"<?php if($vo['id'] == $defaultCate['id']): ?> class="thistab"<?php endif; ?>><a href="javascript:void(0)" ><?php echo $vo['name']; ?></a></li>
			        				<?php endforeach; endif; else: echo "" ;endif; ?>
			        			</ul>
			        		</div>
			        	</div><!--侧导航  end-->
			        	...
			        	<div class="news_rightlist">
				        	<ul>
			        			...
			        			<li id="tabcem1" class="cem_details_box">
			        				<div class="matter_title"><?php echo $defaultCate['name']; ?><span>产品及服务</span></div>
			        				<!--福寿园列表-->
			        				<div class="matter_list">
			        					<ul id='list_box'>
			        						<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$v): ?>
				        						<li>
				        							<div class="matter_img"><a href="<?php echo url('home/Product/detail',array('id'=>$v['id'])); ?>#flagD"><img src="<?php echo $v['photo']; ?>" alt="<?php echo $v['product_name']; ?>" /></a></div>
				        							<p><a href="<?php echo url('home/Product/detail',array('id'=>$v['id'])); ?>#flagD"><?php echo $v['product_name']; ?></a></p>
				        						</li>		        		
			        						<?php endforeach; endif; else: echo "" ;endif; ?>				
			        					</ul>
			        				</div><!--福寿园列表end-->
